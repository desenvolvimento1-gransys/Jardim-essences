let mainColor = '#E4E0DD';
let secondaryColor = '#1D1D1B';
let thirdColor = '#E4E0DD';
let fourthColor = '#8D8D8D';
...
//Muda logo do topo
let logo = "/logo-preto.png";
//Muda logo do footer
let logoAlt = "/logo-preto.png";
...
export default () => ({
    ...
    layout: {
        ...
        LinkTopFace: {
            link: merchantInfo.facebook,
        },
        LinkTopInsta: {
            link: merchantInfo.instagram,
        },
        dialog: {
            exitDialog: {
                width: 300,
